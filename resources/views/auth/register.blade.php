...
<body x-data="{ showModal: false, agree: false }" class="antialiased">
                ...
                <form method="POST" action="{{ route('register') }}">
                    ...
                    <div class="mt-4 flex items-center">
                        <input id="terms" type="checkbox" name="terms"
                            class="h-4 w-4 text-orange-500 border-gray-300 rounded" x-model="agree" />
                        <label for="terms" class="ml-2 text-sm text-gray-600">
                            I agree to the
                            <button type="button" class="text-orange-500 hover:underline" @click="showModal = true">
                                Terms & Conditions
                            </button>
                        </label>
                    </div>
                    ...
                    <div class="mt-6">
                        <button type="submit" :disabled="!agree"
                            :class="agree ? 'bg-orange-500 hover:bg-orange-600 text-white cursor-pointer' :
    ...
    <div x-show="showModal" class="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50 z-50"
        ...
        <div class="bg-white rounded-lg shadow-lg max-w-lg w-full p-6 relative">
            <h3 class="text-xl font-bold text-gray-800 mb-4">Terms & Conditions</h3>
            <div class="text-gray-600 text-sm max-h-64 overflow-y-auto space-y-2">
                <p>1. Anda wajib memberikan data yang benar saat registrasi.</p>
                <p>2. Kami akan menjaga kerahasiaan data pribadi sesuai kebijakan privasi.</p>
                <p>3. Penggunaan akun hanya untuk tujuan yang sah.</p>
                <p>4. Pelanggaran terhadap ketentuan dapat berakibat pada penutupan akun.</p>
                <p>5. Dengan membuat akun, Anda setuju pada semua ketentuan yang berlaku.</p>
            </div>
            <div class="mt-6 flex justify-end space-x-3">
                ...
                <button @click="showModal = false; agree = true"
